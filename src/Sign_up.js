...
function Sign_up(){
    ...
    async function addNewDocument(){
        await setDoc(doc(db, "users", email), {country, city, address, email, userName});
    }
   

    return <div className="sign_up_page">
        <Link to='/'>
             <img src="https://pngimg.com/uploads/amazon/small/amazon_PNG24.png" className="signup_logo" alt='amazon logo'></img>
        </Link>
